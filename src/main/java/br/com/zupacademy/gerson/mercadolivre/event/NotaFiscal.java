...
@Service
public class NotaFiscal implements EventosDeSucesso {
	...
	public void realizaEvento(Compra compra, HttpServletRequest request) {
		...
		Map<String, Object> corpo = Map.of("id_compra", compra.getId(), "id_usuario", compra.getUsuario().getId());

		WebClient client = WebClient.create();

		String response = client.post().uri("http://localhost:8080/nota-fiscal")
